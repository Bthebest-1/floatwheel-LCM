...
void KEY1_Task(void)
{
	...
	switch(KEY1_State)
	{
		...
		case 2:		//˫��	
			if(Power_Flag == 2) //Cycle  throught the brightness settings
			{
				Gear_Position++; 
				if(Gear_Position == 4)
				{
...
/**************************************************
 * @brie   :Power_Display() -> diplaying battery level
 * @note   :������ʾ
 * @param  :��
 * @retval :��
 **************************************************/
void Power_Display(void)
{
	...
	switch(Power_Display_Flag)
	{
		...
		case 8://3.50V~3.62V 3���׵�
			...
			for(i=0;i<num;i++)
			{
				WS2812_Set_Colour(i,WS2812_Measure,WS2812_Measure,WS2812_Measure); //white
			}
			for(i=num;i<10;i++)
			{
				WS2812_Set_Colour(i,0,0,0);
		...
		case 9://3.35V~3.50V 2�����
			...
			for(i=0;i<num;i++)
			{
				WS2812_Set_Colour(i,0,WS2812_Measure,0); //red
			}
			for(i=num;i<10;i++)
			{
				WS2812_Set_Colour(i,0,0,0);
...
/**************************************************
 * @brie   :WS2812() -> displaying footsensor on/off state
 * @note   :����ʾ����WS2812
 * @param  :��
 * @retval :��
 **************************************************/
void WS2812(void)
{
	...
	switch(WS2812_Flag)
	{
		case 1://���5������     �Ҳ�5���Ʋ�����   adc1>2.5V  adc2<2.5V
			for(i=0;i<5;i++)
			{
				WS2812_Set_Colour(i,0,0,WS2812_Measure); //blue
			}
				for(i=5;i<10;i++)
			{
				WS2812_Set_Colour(i,0,0,0);
...
/**************************************************
 * @brie   :WS2812_Boot() -> vesc just booted -> blue and green?
 * @note   :��ʾ����
 * @param  :��
 * @retval :��
 **************************************************/
